...
public abstract class BaseClass
{
    ...
    protected internal virtual string GetDescription() { return this.GetDefaultDescription() + this.GetClassSymbol(); }
    protected internal virtual string GetDefaultDescription() { return "CLASS-"; }
    protected internal abstract string GetClassSymbol();
}
...
internal class DerivedClassA : BaseClass
{
    ...
    protected internal override string GetClassSymbol() { return "A"; }
}
...
class DerivedClassB : DerivedClassA
{
    ...
    protected internal override string GetDefaultDescription() { return string.Empty; }
    protected internal override string GetClassSymbol() { return "B"; }
}
